...
public class Assert {
    ...
    private static boolean equalsRegardingNull(final Object expected,
            final Object actual) {
        if (expected == null) {
            return actual == null;
        }
    ...
    static public void assertNotEquals(final String message,
            final Object unexpected, final Object actual) {
     ...
     *            the value to check against <code>unexpected</code>
     */
    static public void assertNotEquals(final Object unexpected,
            final Object actual) {
     ...
     */
    static public void assertNotEquals(final String message,
            final long unexpected, final long actual) {
     ...
     *            the value to check against <code>unexpected</code>
     */
    static public void assertNotEquals(final long unexpected, final long actual) {
        assertNotEquals(null, unexpected, actual);
    }
     ...
     *            considered equal.
     */
    static public void assertNotEquals(final double unexpected,
     ...
     *            considered equal.
     */
    static public void assertNotEquals(final float unexpected,
     ...
     *            actual values
     */
    public static void assertArrayEquals(final Object[] expecteds,
    ...
    static public void assertEquals(final String message,
        ...
        if (doubleIsDifferent(expected, actual, delta)) {
            failNotEquals(message, Double.valueOf(expected),
    ...
    static public void assertEquals(final String message, final float expected,
        ...
        if (floatIsDifferent(expected, actual, delta)) {
            failNotEquals(message, Float.valueOf(expected),
    ...
    static private boolean doubleIsDifferent(final double d1, final double d2,
            final double delta) {
    ...
    static private boolean floatIsDifferent(final float f1, final float f2,
            final float delta) {
    ...
    static private void failNotNull(final String message, final Object actual) {
        String formatted = "";
        if (message != null) {
            formatted = message + " ";
        }
     ...
     *            the object to compare to <code>unexpected</code>
     */
    static public void assertNotSame(final Object unexpected,
            final Object actual) {
    ...
    static private void failNotSame(final String message,
            final Object expected, final Object actual) {
        String formatted = "";
        if (message != null) {
            formatted = message + " ";
    ...
    private static void failNotEquals(final String message,
            final Object expected, final Object actual) {
     ...
     */
    @Deprecated
    public static void assertEquals(final Object[] expecteds,
            final Object[] actuals) {
