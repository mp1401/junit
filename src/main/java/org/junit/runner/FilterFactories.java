...
class FilterFactories {
     ...
     * 
     * A filter specification is of the form
     * "package.of.FilterFactory=args-to-filter-factory" or
     ...
     */
    public static Filter createFilterFromFilterSpec(final Request request,
            final String filterSpec)
            throws FilterFactory.FilterNotCreatedException {
        final Description topLevelDescription = request.getRunner()
                .getDescription();
        String[] tuple;
        ...
        return createFilter(tuple[0], new FilterFactoryParams(
                topLevelDescription, tuple[1]));
    }

    /**
     * Creates a {@link Filter}.
     * 
     * @param filterFactoryFqcn
     *            The fully qualified class name of the {@link FilterFactory}
     * @param params
     *            The arguments to the {@link FilterFactory}
     */
    public static Filter createFilter(final String filterFactoryFqcn,
            final FilterFactoryParams params)
            throws FilterFactory.FilterNotCreatedException {
     ...
     *            The class of the {@link FilterFactory}
     * @param params
     *            The arguments to the {@link FilterFactory}
     * 
     */
    ...
    static FilterFactory createFilterFactory(final String filterFactoryFqcn)
        ...
        try {
            filterFactoryClass = Classes.getClass(filterFactoryFqcn)
