...
class JUnitCommandLineParseResult {
                ...
                if (arg.startsWith("--filter=") || arg.equals("--filter")) {
                    ...
                    if (arg.equals("--filter")) {
                        ...
                        if (i < args.length) {
                            ...
                            parserErrors.add(new CommandLineParserError(arg
                                    + " value not specified"));
                            break;
                        }
                    } else {
                    ...
                    parserErrors
                            .add(new CommandLineParserError(
    ...
    public Request createRequest(final Computer computer) {
        if (parserErrors.isEmpty()) {
            final Request request = Request.classes(computer,
    ...
    private Request applyFilterSpecs(Request request) {
        try {
            for (final String filterSpec : filterSpecs) {
                final Filter filter = FilterFactories
