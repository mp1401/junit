 ...
 * </pre>
 * <p>
 * Each test is run in a new thread. If the specified timeout elapses before the
 * test completes, its execution is interrupted via {@link Thread#interrupt()}.
...
public class Timeout implements TestRule {
    ...
    /**
     * Create a {@code Timeout} instance with the timeout specified in
     * milliseconds.
     * <p>
     ...
     * 
     * @param millis
     *            the maximum time in milliseconds to allow the test to run
    ...
    /**
     * Create a {@code Timeout} instance with the timeout specified at the
     * timeUnit of granularity of the provided {@code TimeUnit}.
     * 
     * @param timeout
     *            the maximum time to allow the test to run before it should
     *            timeout
     * @param timeUnit
     ...
     * 
     * @param t
     *            the {@code Timeout} instance to copy
     * @param lookForStuckThread
     *            whether to look for a stuck thread
     * @since 4.12
     */
    protected Timeout(final Timeout t, final boolean lookForStuckThread) {
        timeout = t.timeout;
        timeUnit = t.timeUnit;
     ...
     * @since 4.12
     */
    protected Timeout(final long timeout, final TimeUnit timeUnit,
            final boolean lookForStuckThread, final boolean enableWhenDebugging) {
        this.timeout = timeout;
        this.timeUnit = timeUnit;
        this.lookForStuckThread = lookForStuckThread;
     ...
     * this feature is enabled, the test will look for a thread that appears to
     * be stuck and dump its backtrace. This feature is experimental. Behavior
     * may change after the 4.12 release in response to feedback.
     * 
     * @param enable
     ...
     * @since 4.12
     */
    public Timeout lookingForStuckThread(final boolean enable) {
     ...
     * 
     * <p>
     * Timeouts or time sensitive logic in the code under test is not handled by
     * this feature and may make this less useful in some circumstances.
     * </p>
     * 
     * <p>
     ...
     * 
     * @param enable
     *            {@code false} to disable timeouts when debugging.
     * @return This object
     * @since 4.12
     */
    public Timeout whenDebugging(final boolean enable) {
    ...
    boolean isDebugging(final List<String> arguments) {
        /*
         * Options specified in:
         * http://docs.oracle.com/javase/6/docs/technotes/guides
         * /jpda/conninv.html#Invocation
         * http://docs.oracle.com/javase/7/docs/technotes
         * /guides/jpda/conninv.html#Invocation
         * http://docs.oracle.com/javase/8/docs
         * /technotes/guides/jpda/conninv.html#Invocation
         */
