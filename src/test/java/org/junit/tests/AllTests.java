...
@SuiteClasses({ AssumptionTest.class, ClassRequestTest.class,
        ...
        TestDescriptionTest.class, TestDescriptionMethodNameTest.class,
        SuiteDescriptionTest.class, AllTestsTest.class, AnnotationTest.class,
        AssertionTest.class, CommandLineTest.class, ExpectedTest.class,
        ComparisonFailureTest.class, MultipleFailureExceptionTest.class,
        ForwardCompatibilityTest.class, OldTests.class,
        ParameterizedTestTest.class, RunWithTest.class, RunnerTest.class,
        SuiteTest.class, TestListenerTest.class, TestMethodTest.class,
        TextListenerTest.class, TimeoutTest.class, EnclosedTest.class,
        ...
        JUnitCoreReturnsCorrectExitCodeTest.class, SuiteMethodTest.class,
        IgnoreClassTest.class, OldTestClassAdaptingListenerTest.class,
        AnnotatedDescriptionTest.class, AssumptionViolatedExceptionTest.class,
        ExperimentalTests.class, InheritedTestTest.class, TestClassTest.class,
        ...
        TheoriesPerformanceTest.class, UseSuiteAsASuperclassTest.class,
        FilterableTest.class, FilterTest.class, MaxStarterTest.class,
        JUnit38SortingTest.class, MethodRulesTest.class, TestRuleTest.class,
        TimeoutRuleTest.class, TimeoutRuleDebuggingTest.class,
        ...
        RuleMemberValidatorTest.class, RuleChainTest.class,
        BlockJUnit4ClassRunnerTest.class, MethodSorterTest.class,
        TestedOnSupplierTest.class, StacktracePrintingMatcherTest.class,
        StopwatchTest.class, RunNotifierTest.class,
        ConcurrentRunNotifierTest.class, SynchronizedRunListenerTest.class,
        ...
        FrameworkMethodTest.class, FailOnTimeoutTest.class,
        JUnitCoreTest.class, TestWithParametersTest.class,
        ParameterizedNamesTest.class, PublicClassValidatorTest.class })
